...
<body id="mainbody">
	...
	<form action="${contextPath}/login" method="post" class="form-signin">
			...
			<div class="btn-group">
			<button class="btn btn-success" type="submit" id="signIn"><fmt:message key="login.signin" bundle="${bundle}"/></button> 
			<button class="btn btn-primary" type="button" id = "signUp"><fmt:message key="login.signup" bundle="${bundle}"/></button>
			</div>
			<br/>
