...
<body id="mainbody">
	...
	<form action="${contextPath}/login" method="post" class="form-signin">
			...
			<input type="text" class="form-control" name="username" placeholder="${insertUsername}" autofocus=""/>
			<input type="password" class="form-control" name="password" placeholder="${insertPassword}" autofocus=""/>
			<div class="btn-group">
